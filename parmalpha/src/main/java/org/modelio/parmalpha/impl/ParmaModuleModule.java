 ...
 * 
 */
public class ParmaModuleModule extends AbstractJavaModule {

	private ParmaModulePeerModule peerModule = null;

	private ParmaModuleSession session = null;
	
	private static ParmaModuleModule instance;

	public ParmaModuleModule getInstance() {
		return instance;
	}

	@Override
	public ParmaModulePeerModule getPeerModule() {
	 ...
	 */
	public ParmaModuleModule(IModuleContext moduleContext) {
		super(moduleContext);
		this.session = new ParmaModuleSession(this);
		this.peerModule = new ParmaModulePeerModule(this, moduleContext.getPeerConfiguration());
